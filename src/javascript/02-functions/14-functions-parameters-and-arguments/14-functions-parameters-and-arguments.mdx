...
Remember when a variable is not set to anything, its value is `undefined`. So you cannot go ahead and pass zero here and expect it to fall back to the default.
